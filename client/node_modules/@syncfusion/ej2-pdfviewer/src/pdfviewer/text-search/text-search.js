    ...
    TextSearch.prototype.createRequestForSearch = function (pageIndex) {
        ...
        var _loop_1 = function (x) {
            var _loop_2 = function (y) {
                ...
                if (this_1.pdfViewerBase.clientSideRendering) {
                    var textDetailsId_1 = this_1.pdfViewerBase.documentId + '_' + pageIndex + '_textDetails';
                    var isTextNeed_1 = this_1.pdfViewerBase.pageTextDetails ? this_1.pdfViewerBase.pageTextDetails[textDetailsId_1] ? false : true : true;
                            ...
                            case 'imageRenderedSearch':
                                if (event.data.message === 'imageRenderedSearch') {
                                    ...
                                    if (isTextNeed_1) {
                                        ...
                                        var textDetails = JSON.parse(proxy.pdfViewerBase.pageTextDetails["" + textDetailsId_1]);
